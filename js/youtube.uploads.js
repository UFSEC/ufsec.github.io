jQuery(document).ready(function() {
    ...
    var itemHTML = "<div class=\"col-lg-4 col-md-6 mb-4\">" +
      ...
      if (githubLink.length > 0) {
        ...
        "<div class=\"feed-item-info\">" +
          "<p class=\"code-link\" ><a href=\" " + githubLink + "\"><i class=\"fab fa-github\" aria-hidden=\"true\"></i> See the code</a></p>" +
        "</div>"
  ...
  var tutorialFeed = $(this).find('#tutorials-row');
